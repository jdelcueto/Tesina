...
#+BEGIN_SRC latex
  Considerando el objetivo de su reflexión, resulta llamativo el modo en que Anscombe comienza y termina su artículo. En el centro de su atención está el misterio de la presencia de Jesús en la Eucaristía; entonces elige comenzar su discusión diciendo: \blockquote[{\cite[108]{anscombe1981erp:ot}}: It is easiest to tell what transubstantiation is by saying this: little children should be taught about it as early as possible. El texto en español de este artículo se ha tomado de {\cite{torralbaynubiola2005fayeh:ot}}]{La manera más sencilla de decir qué es la transubstanciación es diciendo esto: debería enseñársele a los niños pequeños lo más temprano posible.}

  \blockquote[{\cite[112]{anscombe1981erp:ot}}: It is the mystery of faith which is the same for the simple and for the learned. For they believe the same, and what is grasped by the simple is not better understood by the learned: their service is to clear away the rubbish which the human reason so often throws in the way to create obstacles.]{Este es el misterio de fe el cual es el mismo para el simple y para el docto. Pues ambos creen lo mismo, y lo que es entendido por el simple no es mejor comprendido por el docto: su servicio consiste en quitar de en medio la basura que la razón humana arroja con tanta frecuencia en el camino para crear obstaculos.}
#+END_SRC
