...
Ordinariamente las personas toman parte en la actividad humana que es el
lenguaje. Juegan el juego del lenguaje. ¿Jugarlo es entenderlo? A la vista de
Wittgenstein saltaban extraños problemas sobre las reglas de este juego; entonces
no podía evitar escudriñarlas al detalle.\footcite[cf.~][loc.7099]{monk} Esta
cualidad del carácter filosófico de Wittgenstein motivó que se preocupase por
investigaciones acerca de las cuestiones más fundamentales. Estudiando
ingeniería en Manchester se interesó por los fundamentos de las matemáticas.
Desde las perspectivas de Frege y Russell identificó los problemas de explicar
dichos fundamentos en términos de verdades lógicas. Confrontando estos problemas
describió los problemas fundamentales de la filosofía como confusiones en el uso
del lenguaje. La investigación para disolver las confusiones filosóficas es una
investigación sobre el significado y el sentido del lenguaje.

Las cuestiones de la filosofía no son problematicas por ser erróneas, sino por
...
expresiones. La filosofía no es un cuerpo doctrinal, sino
actividad\footcite[cf.~][4.112]{tractatus}y terapia\footcite[cf.~][\S133]{PI}.  

Wittgenstein sostuvo dos grandes descripciones del significado.
...
Ambas obras generaron un 'corte' en la historia de la filosofía, es decir,
causaron un cambio en el modo de hacer
filosofía.\footcite[cf.~][p.~181]{twocuts} 
...
\todo{REVISAAAARRR!!! Aquí se puede incluir aquello de la metodología de
    Wittgenstein que concierne tanto al Tractatus como a PI}
