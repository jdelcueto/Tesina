...
además fue motivo de confusión en la tarea de entender el Tractatus desde el
inicio. Cuando Russell recibió el manuscrito en agosto escribió a Wittgenstein
cuestionando algunos puntos difíciles del texto. En su carta observaba:
\citalitinterlin{Estoy convencido de que estás en lo correcto en tu principal
...
año: \citalitinterlin{La importancia de la ``tautología'' para una definición de
las matemáticas me fue señalada por mi ex-alumno Ludwig Wittgenstein, quien
...
La respuesta de Wittgenstein no solo pone de manifiesto su cambio de enfoque,
...
\todo{3.4.3 La diferencia entre decir y mostrar}
En el prefacio del tratado Wittgenstein ofrece una aclaración sobre el objetivo
de su tratado. Afirma que el libro ``trazará un limite al pensamiento'', y afina
diciendo ``o más bien, no al pensamiento, sino a la \emph{expresión de los
    pensamientos}; puesto que para ser capaces de demarcar un límite al
pensamiento tendríamos que poder pensar desde ambos lados de este límite
(así tendríamos que poder pensar lo que no puede ser pensado)''. 
