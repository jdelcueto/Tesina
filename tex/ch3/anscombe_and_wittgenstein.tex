...
\todo{3.3 De la ilustración al tractatus}Para Wittgenstein él método para
formular los problemas filosóficos se apoya en la mala comprensión de la lógica
de nuestro lenguaje. En otras palabras: \citalitinterlin{Lo que puede ser dicho en
    absoluto puede ser dicho claramente; y de lo que uno no puede hablar de eso
    uno debe guardar silencio}\footcite[prefacio]{tractatus}
...
\todo{3.4.1 La filosofía como actividad}En el Tractatus Wittgenstein insiste en
