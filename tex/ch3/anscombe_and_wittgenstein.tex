...
\todo{3.3 De la ilustración al tractatus}Para Wittgenstein este era el método
...
\citalitinterlin{
    Lo que \todo{traducción difícil. \emph{``What can be said at all''}}siquiera
    puede ser dicho puede ser dicho claramente; y de lo que uno no puede hablar
    de eso uno debe guardar silencio}\footcite[prefacio]{tractatus} 
