...
#+BEGIN_SRC latex
  ...
  profecías cumplidas? ¿Pueden ser estos sólidos argumentos externos para creer en
...
#+BEGIN_SRC latex
  ...
  sería si nos preguntamos a quién nos referimos por `Alejandro', si en algún
  momento fue reemplazado por un impostor, por ejemplo, pero acerca de la
  ...
  históricas; \blockquote[{\cite[27]{anscombe2008faith:prophandmi}}: I object to
  his lumping together everything historical as of inferior certainty to my own
  ...
  normal circumstances, just by his reappearance alive.]{éstas pertenecen al
    ...
    \textelp{} con éstas no hay peligro de toparse con algo que las contradiga, y
...
#+BEGIN_SRC latex
  ...
  reflexión está el requisito propuesto por Lessing de que para que la aplicación
  de una profecía a algún hecho no sea \emph{accidental},
  \blockquote[{\cite[29]{anscombe2008faith:prophandmi}}: that it should be clear
  that this is what he meant]{debería de quedar claro que ésto es a lo que este se
    refería}.
  ...
  considerably, because it is not possible to `mean' any but a very
  restricted range of future events in the way in which one can `mean' present [or]
