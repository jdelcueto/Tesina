...
#+BEGIN_SRC latex
  ...
  Lessing alude a que la dificultad tiene que ver con que no se puede saltar a una
  clase distinta de verdades

  pero Anscombe se fija en la fuerza de la certeza

  Lessing concede a los datos históricos el grado de certeza de probabilidad.

  Anscombe juzga que la probabilidad, en oposición a la total certeza, entra en
  juego más tarde. Por ejemplo si se pregunta uno a quién se refiere por Alejandro

  Su objeción es contra amontonar todo lo histórico como de certeza inferior a mi
  propia experiencia.
  ...
  range of things in history were not quite solid]{}

  what about what we were talking about: the resurrecction?

  it is not solid in this fashion

  it belongs to the very large realm of historical assertions which it would
  indeed be absurd to claim certainty for, but the time for disprooving which is
  past.

  she thinks lessing is unconscious of the existence of this class of assertions
