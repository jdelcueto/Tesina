...
#+BEGIN_SRC latex
  ...
  por Lessing. Éste se puede sintetizar en que sea razonable la preocupación:
  \enquote{Pero estas cosas \emph{pueden} no ser verdad, ¿cómo puedo emplearlas
    para apoyar el Cristianismo?}
