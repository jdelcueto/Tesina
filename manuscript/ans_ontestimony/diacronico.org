...
#+BEGIN_SRC latex
  ...
  Anscombe toma las expresiones de Parmenides\footnote{Algunos fragmentos del \emph{Poema
  ...
  y ofrece una construcción de su argumento sobre lo posible y lo concebible:
  ...
  $\therefore$ What is not can't be thought
    ...
    $\therefore$ Lo que no es no puede ser pensado} Anscombe analizará estas dos
  premisas y su conclusión y llegará a una conclusión equivalente a la afirmación
  Wittgensteiniana: \blockquote[{\cite[8]{anscombe1981parmenides:pmc}}: ``whatever
  can be said at all can be said clearly'']{todo lo que puede ser expresado en
    absoluto puede ser expresado claramente}.
