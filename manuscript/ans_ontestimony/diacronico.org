...
#+BEGIN_SRC latex
  ...
  de los milagros y profecías es como un observador imparcial e indiferente. Éste
  ...
  `solid external arguments' of the Vatican decree?]{si \textins{lo que}
    ...
    `solidos argumentos externos' de la constitución del Vaticano?}. Si se tiene
  ...
  Este criterio, que sirve para remover los obstáculos que impiden la creencia, no
  ofrece una razón positiva para creer. La razón positiva para creer es la
  consonancia con la doctrina conocida.



  Pero, uno podría decir, quizás uno podría hacer algo en otras circunstancias
  permisible `porque uno no se atreve a hacerlo de otro modo' en un caso en el que
  no hay ningún signo de que el hombre es presuntuoso y el hace lo que es una de
  dos, de Dios o es presuntuoso; pero puede uno creer algo por una razón como
  esa?: a saber que el hombre que lo dice es de Dios o presuntuoso y no hay ningún
  signo de que sea presuntuoso? Sin duda uno quisiera razón positiva para creer y
  no meramente ausencia de razón positiva para descreer?

  Esto, me parece a mi, es correcto, y va con la tésis de que en cierto sentido no
  puede haber un profeta con una nueva doctrina.
#+END_SRC
