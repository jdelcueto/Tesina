...
#+BEGIN_SRC latex
  ...
  El punto de partida de Anscombe para esta discusión es su
  reconstrucción\footnote{Algunos fragmentos del \emph{Poema de Parmenides}
  ...
  de un argumento Parmenidiano que presenta como sigue:
  \blockquote[{\cite[3]{anscombe1981parmenides:pmc}}: Parmenides' arguments runs:
