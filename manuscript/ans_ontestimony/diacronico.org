...
#+BEGIN_SRC latex
  ...
  Para casi todas las profecias, tenerlas por cumplidas es interpretarlas

  all but prophecy of a

  en definitiva llega a que ver la profecía cumplida es interpretarla
  es sin sentido preguntar qué tuvo en mente el profeta
  ...
  - preguntar qué tuvo en mente el profeta es sin sentido

  - el principio crítico de que los escritos proféticos tienen que haber sido
  claramente inteligibles en su propia época es en sí mismo una negación de la
  posibilidad de todo menos un tipo muy restringido de profecía
