...
#+BEGIN_SRC latex
  ...
  Professor A.J.Ayer.]{Probablemente la tesis más conocida del \emph{Tractatus} es
    ...
    entonces son sin-sentido. Este fue el método adoptado por el Círculo de Vienna
  ...
  \emph{Tractatus}. There is nothing about sensible verification there.]{Hay
    ciertas dificultades para ascribir esta doctrina al \emph{Tractatus}. No hay
  ...
  señalar lo que ocurre y decir como está haciendose presente Jesús y cómo hemos
