...
#+BEGIN_SRC latex
  ...
  Este relato de los Hechos de los Apóstoles puede servir de punto de partida para
  examinar el modo en que la Escritura nos describe el testimonio.
  \citalitinerlin{El testimonio bíblico es esencialmente religioso. Se trata de un
    testimonio sobre alguien: el Dios salvador (AT) o el
    Dios-salvación-en-Jesucristo (NT) 1530}
