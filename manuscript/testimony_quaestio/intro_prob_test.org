...
#+BEGIN_SRC latex
  ...
  Cristo, a lo largo de su misión, dió testimonio del amor del Padre
  \citalitinterlin{habiendo amado a los suyos que estaban en el
    mundo\ldots}\footnote{Jn 13,1}. En el misterio pascual, donde \citalitinterlint{los
  amó hasta el extremo}\footnote{Jn 13, 1}, queda confirmado definitivamente como
  testigo del Padre.

  también ha dado testimonio
  \citalitinterlin{Porque tanto amó Dios al mundo, que entregó a su Unigénito,
    para que todo el que cree en él no perezca, sino que tenga vida
    eterna}\footnote{Jn 3,16}
