...
#+BEGIN_SRC latex
  ...
  preguntas, de modo que hay que traer a la mente una explicación adecuada.

  Teniendo en cuenta los desafíos lanzados por al filosofía moderna y algunas
  reflexiones contemporaneas que ofrecen puntos de contacto con la filosofía de
  Elizabeth Anscombe formularemos aquí algunas preguntas relacionadas con el
  testimonio y la revelación. Hasta el momento sólo nos hemos planteado una
  pregunta que ahora podemos ampliar: ¿qué es conocer una verdad para la vida por
  el testimonio de la revelación divina?
