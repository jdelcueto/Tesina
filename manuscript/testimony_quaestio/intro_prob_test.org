...
#+BEGIN_SRC latex
  ...
  que\citalitinterlin{atraviesa toda la Escritura y se corresponde con la
    ...
    109} Adicionalmente, según Latourelle: \citalitinterlin{El testimonio
    pertenece al grupo de analogías empleadas por la Escritura para introducir al
    hombre en las riquezas del misterio divino, por ejemplo las categorías de
    alianza, de palabra, de paternidad y de filiación.}\footnote{latourelle
    p.1523}

  Estas consideraciones permiten tener como clave para el estudio de la categoría
  del testimonio en la escritura
  entender al testimonio como estructura de la revelación, o la revelación como
  acto testimonial de Dios
  entender el testimonio como actividad humana cuyos rasgos el testimonio bíblico
  asume, pero al mismo tiempo exalta hasta sublimarlos.

  Estas consideraciones permiten valorar la economía de la revelación como
  manifestación de Dios realizada con una estuctura testimonial y que puede ser
  comprendida atendiendo los rasgos del testimonio como actividad humana
  ...
  nuestra historia humana.\footnote{El testimonio pertenece al grupo de analogías
    ...
    paternidad y de filiación. p.1523}

  La revelación de Dios así descrita tiene
  ...
  La Revelación como acto testimonial de Dios en el AT

  La
  #+END_SRC
El testimonio en la escritura
intro:
la igl no olvida el motivo de su esperanza
si partimos desde la vivencia de la igle hoy nos encontramos una igl q guarda y transmite
el motivo de su esperanza
esta acción evangelizadora la podemos recoger en la exp: palabra vivida en el esp
...
#+BEGIN_SRC latex
  ...
  El misterio al que este anuncio se refiere
#+END_SRC
