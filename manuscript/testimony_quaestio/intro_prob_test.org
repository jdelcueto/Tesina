...
#+BEGIN_SRC latex
  ...
  su misterio y la vida que el ofrece.

  YHWH también aparece en el AT como testigo de los mandamientos contenidos en la
  Ley.\footnote{prades 115} Ésta queda grabada en las ``tablas del testimonio'' y
  confiadas a Moisés:\citalitinterlin{Cuando acabó de hablar con Moisés en la
    montaña del Sinaí, le dio las dos tablas del Testimonio, tablas de piedra
    escritas por el dedo de Dios.}\footnote{Ex 31,18} Este testimonio se enfrenta
  a un pueblo con el corazón extraviado:\citalitinterlin{Al acercarse al
    campamento y ver el becerro y las danzas, Moisés, encendido en ira, tiró las
    tablas y las rompió al pie de la montaña.}\footnote{Ex 32,19} Sin embargo Dios
  no se detiene ante el extravío del pueblo. Las tablas del testimonio son
  reconstruidas:
  ...
  con el pueblo. Así como en Moisés Dios se revela por medio de personas escogidas
  por él y estos que Él elige como testigos suyos en cada etapa de la historia del
  pueblo son testimonio de su fidelidad.
  ...
  \citalitlar{es Dios quien da testimonio de sí mismo y de sus obras y designios a
    ...
    mismo YHWH, que es quien los escoge y envía.\footnote{prades 116-117}}
  ...
  pertenece, sino que \citalitinterlin{procede de una iniciativa absoluta, en
    cuanto a su origen y en cuanto a su contenido}\footnote{prades 118}, puesto
  ...
  \citalitlar{Saca afuera a un pueblo que tiene ojos, pero está ciego, que tiene
    ...
    testigos --—oráculo del Señor--—: yo soy Dios. Lo soy desde siempre, y nadie
    se puede liberar de mi mano. Lo que yo hago ¿quién podría deshacerlo?}
  ...
  \citalitinterlin{no hay testigo de lo absoluto que no sea testigo de signos
    históricos, no hay confesor del sentido absoluto que no sea narrador de actos
    redentores.}\footnote{prades 119; P. Ricoeur Lhermeneutique 44-46}
