...
#+BEGIN_SRC latex
  ...
  Hasta aquí se ha empleado la categoría del testimonio sin problematizarla. Es
  ...
  Hasta el momento sólo hemos formulado una pregunta, que ahora podemos
  ampliar: ¿qué es conocer una verdad para la vida por el testimonio de la
  revelación divina? ¿Qué otros cuestionamientos se pueden plantear relacionados
  con este fenómeno? Es posible agrupar algunos desafíos y aportaciones de la
  filosofía moderna y contemporánea en varías preguntas principales. Éstas serán
  útiles a la hora de indagar en el pensamiento de Elizabeth Anscombe.
  ...
  valor epistemológico del testimonio se puede plantear diciendo: ¿cómo adquirimos
  efectivamente una creencia verdadera justificada sobre la base de lo que alguien
  nos ha dicho?

  Cómo se ve una descripción del conocer que tenga en cuenta el testimonio?
  ¿Cómo se ve una descripción del conocer
  Si se entiende
  ...
  What is of import for justification or knowledge that is distinctively
  testimonial is that a hearer form a given belief on the basis of the content of
  ...
  of the epistemology of testimony, and the current philosophical literature
